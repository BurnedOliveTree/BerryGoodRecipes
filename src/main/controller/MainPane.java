...
public class MainPane {
    ...
    public void onClickButton() {
        ...
        try {
            ...
            RecipePane controller = new RecipePane(new Recipe(1,"Placki", new User(3, "Karolina", "1234"), "Zrób farsz i nagrzej patelnie", 0, "2020-01-01", 10, 20, 4,  new ArrayList<>(){{add(new Ingredient(200, new Unit(), "Twaróg"));}}));
