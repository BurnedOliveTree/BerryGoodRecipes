...
(
    ...
    RECIPE_ID number(4) constraint PUB_RECIPE_ID references RECIPE(RECIPE_ID) on delete cascade
);
...
(
    ...
    OPINION_ID number(4) constraint REPORTED_OPINION_ID references OPINION(OPINION_ID)  on delete cascade
);