...
(
    ...
    RECIPE_ID number(4) constraint IL_RECIPE_ID_FK references RECIPE(RECIPE_ID),
    AMOUNT number(8, 2),
...
(
    ...
    INGREDIENT_LIST_ID number(4) not null constraint SHOPPING_INGREDIENT_FK references INGREDIENT_LIST (INGREDIENT_LIST_ID),
